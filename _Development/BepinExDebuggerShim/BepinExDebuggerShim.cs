namespace BepinExDebuggerShim
{
    ...
    public class DebuggerShimPlugin : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            {
                log.LogError("No mods dir found!  Nothing to load!");
                return;
            }
            ...
            foreach (var file in filesInDir)
            {
                ...
                // TODO figure out the right logic for this and reenable
        ...
        private static void GenerateMdbManaged(FileInfo file)
        {
            ...
            // .pdb files must be deleted prior to loading the .mdb otherwise Visual Studio won't properly resolve locals when debugging
            File.Delete(pdbFileInfo.FullName);
